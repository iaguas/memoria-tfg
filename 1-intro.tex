...
\begin{figure}[h!]
\begin{center}
\includegraphics[width=10cm]{img/molino.jpg}
\caption{Distinguir el molino del pueblo del fondo no es difícil para un humano aunque sí para una máquina. \label{img:ejemplomolino}}
\end{center}
\end{figure}
...
\begin{figure}[h!]
\begin{center}
\subfigure[]{\includegraphics[width=0.25\textwidth]{img/rice.jpg}}\quad
\subfigure[]{\includegraphics[width=0.25\textwidth]{img/umbra_rice.jpg}}\\
\subfigure[]{\includegraphics[width=0.45\textwidth]{img/hist_rice.jpg}}
\caption{(a) Imagen original. (b) Imagen segmentada. (c) Histograma de la imagen original. Se puede ver que en t=71 se produce un mínimo con respecto a los otros niveles de gris y que por eso se escoge como umbral. \label{img:rice}}
\end{center}
\end{figure}
