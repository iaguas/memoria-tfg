% TRABAJO FINAL DE GRADO - ALGORITMO 1 CON DOMBI
% Inigo Aguas Ardaiz
% UPNA, 25 de junio de 2015.

% Función que implementa el algoritmo 1 para las funciones de Dombi.
function [tseg, segImg] = alg1(I, tipoREF1, d)
    ...
    % Se dispone de la función REF2(x,y) que implementa 1-|x-y|^2.
